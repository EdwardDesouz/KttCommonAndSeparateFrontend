...
setFilteredHsCodeSuggestions,
  ...
  const deleteCascRow = async (itemIndex, rowIndex) => {
    ...
    try {
      ...
      await API.delete(
        `transhipment/deleteTransCascByCascId/${cascId}/${rowNo}/${permitId}/`,
      );
  ...
  //     try {
  //       await API.post("transhipment/deleteTransItem/", {
  //         PermitId: permitId,
  //         ItemNos: selectedItems,
  //       });
  //     } catch (mirrorErr) {
  ...
  const deleteSelectedItems = async () => {
    ...
    try {
      ...
      try {
        await API.post("transhipment/syncTransItemFromCommon/", {
          PermitId: permitId,
        });
      } catch (syncErr) {
        alert(
...
// Certificate of Origin
  ...
  //         ItemNo: item.ItemNo,
  //         PermitId: permitDetails?.PermitId,
  //         MessageType: item.MessageType || "TNPDEC",
  //         HSCode: item.HSCode || "",
  ...
  const ItemEditAll = async () => {
    ...
    try {
      ...
      try {
        // await API.post("transhipment/editTransAllItems/", payload);
