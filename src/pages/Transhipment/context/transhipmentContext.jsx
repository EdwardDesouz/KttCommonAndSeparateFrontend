...
const TranshipmentContext = createContext();

export const TranshipmentProvider = ({ children }) => {
  // Permit Details
  ...
  const [textileCategory, setTextileCategory] = useState(""); // showItemTexttile only
  const [textileQuotaQty, setTextileQuotaQty] = useState("0.00"); // showItemTexttile only
  const [textileQuotaUOM, setTextileQuotaUOM] = useState("--Select--"); // showItemTexttile only
...
export const useTranshipment = () => useContext(TranshipmentContext);
