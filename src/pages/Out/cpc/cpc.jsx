...
function Cpc({ setActiveTab, isViewMode }) {
  ...
  useEffect(() => {
    ...
    if (showSts) logRows("STS", stsRows);
    if (showStsCwc) logRows("STSCWC", stsCwcRows);
    if (showDeferredPrinting) logRows("DEFERREDCO", deferredPrintingRows);
    if (cnBChecked) {
...
aeoRows, cwcRows, seaStoreRows, stsRows, stsCwcRows, deferredPrintingRows, internationalPermitExchangeRows,
  showAeo, showCwc, showSeaStoreCpc, showSts, showStsCwc, showDeferredPrinting, showInternationalPermitExchange,
  cnBChecked, permitDetails, user,
  ]);
  ...
  return (
    <div className="row g-2 container mt-4">
      ...
      <div className="col-12">
        <div className="row align-items-center compact-row">
          <label className="col-sm-2 col-form-label"> SEA STORE</label>
          <div className="col-sm-1 icon-contaniner">
            <input
              type="checkbox"
              id="SeaStore"
        ...
        {showSeaStoreCpc && renderTable(seaStoreRows, setSeaStoreRows)}
      </div>

      {/* STS */}
      <div className="col-12">
        <div className="row align-items-center compact-row">
          <label className="col-sm-2 col-form-label">STS</label>
          <div className="col-sm-1 icon-contaniner">
            <input
              type="checkbox"
              id="Sts"
        ...
        {showSts && renderTable(stsRows, setStsRows)}
      </div>

      {/* STS & CWC */}
      <div className="col-12">
        <div className="row align-items-center compact-row">
          <label className="col-sm-2 col-form-label">STS & CWC</label>
          <div className="col-sm-1 icon-contaniner">
            <input
              type="checkbox"
              id="StsCwc"
        ...
        {showStsCwc && renderTable(stsCwcRows, setStsCwcRows)}
      </div>

      {/* DEFERRED PRINTING OF CO */}
      <div className="col-12">
        <div className="row align-items-center compact-row">
        ...
        {showDeferredPrinting &&
          renderTable(deferredPrintingRows, setDeferredPrintingRows)}
      </div>
