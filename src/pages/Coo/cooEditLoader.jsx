...
function CooEditLoader({ permitId, isEditMode }) {
  ...
  const populateFields = async (d, permitId) => {
    try {
      ...
      // ── CERTIFICATE TYPE 1 ─────────────────────────────────────────
      const certType1Value = d.CerDetailtype1 || "";
      setCertficateType1(certType1Value);
      setSummaryCertificateType(certType1Value);
      // RESET all certificate-type-1-driven visibility first
      ...
      if (
        certType1Value ===
          "1 : Generalised System of Preferences (GSP) Form A" ||
        certType1Value === "12 : Global System of Trade Preference (GSTP)"
      ) {
        setShowInvoiceNo(true);
        setShowOriginCriterion(true);
      } else if (certType1Value === "5 : Commonwealth Preference Certificate") {
        setShowCommonHealth(true);
      } else if (certType1Value === "2 : GSP Form A under Cumulative ASEAN") {
        setShowInvoiceNo(true);
        setShowOriginCriterion(true);
        setShowCifFobValue(true);
        setShowGPS(true);
      } else if (
        certType1Value === "3 : Back to Back GSP Form A" ||
        certType1Value === "34 : Back-to-Back Form RCEP"
      ) {
        setShowInvoiceNo(true);
        setShowOriginCriterion(true);
      } else if (
        certType1Value === "4 : Ordinary Certificate of Origin" ||
        certType1Value === "4A : Certificate of Processing" ||
        certType1Value === "7 : Form W (reserve)"
      ) {
        // all visibility stays false (already reset above)
      } else if (
        certType1Value ===
        ...
        certType1Value === "16 : ASEAN Trade in Goods Agreement (ATIGA)" ||
        certType1Value === "17 : Back to Back ATIGA Form D" ||
        certType1Value === "18 : Preferential Certificate of Origin for FTA" ||
        certType1Value === "19 : Asean-China FTA Form E" ||
        certType1Value === "20 : Back-to-Back ACFTA Form E" ||
        certType1Value === "21 : India Singapore CECA CO" ||
        certType1Value === "22 : Back-to-Back AKFTA Form AK" ||
        certType1Value === "23 : Asean-Korea FTA Form AK" ||
        certType1Value === "24 : Certificate of Origin Generic Form Z" ||
        certType1Value === "25 : Asean Japan CEP Form AJ" ||
        certType1Value === "26 : Back-to-Back AJCEP Form AJ" ||
        certType1Value === "27 : Asean India FTA Form AI" ||
        certType1Value === "28 : Back-to-Back AIFTA Form AI" ||
        certType1Value === "29 : Asean-Australia-New Zealand FTA Form AANZ" ||
        certType1Value === "30 : Back-to-Back AANZFTA Form AANZ" ||
        certType1Value === "31 : ASEAN-Hong Kong FTA Form AHK" ||
        certType1Value === "32 : Back-to-Back AHKFTA Form AHK" ||
        certType1Value ===
      ...
      if (exporterCodeVal) {
        try {
          ...
          if (matched) {
            ...
            setSummaryExporterCruei(matched.CRUEI || "");
            setSummaryExporterName(matched.Name || "");
          }
        } catch (err) {
