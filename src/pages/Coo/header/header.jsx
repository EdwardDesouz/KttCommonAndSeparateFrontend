...
function Header({ setActiveTab, isViewMode,isEditMode }) {
  ...
  const fetchDeclarationTypeData = async () => {
    try {
      const response = await API.get(
        "/getDeclarationTypeFromCommonMasterForTranshipment/",
      );
  ...
  //   if (value === "BRE : BLANKET REMOVAL") {
  //     setShowPartyImporter(true);
  //     setShowInwardTransport(false);
  //     setShowOutwardTransport(false);
  //     setShowHandlingAgent(false);
  //   } else if (value === "IGM : INTER-GATEWAY MOVEMENT") {
  //     setShowPartyImporter(true);
  //     setShowOutwardCarrier(true);
  //     setShowInwardCarrier(true);
  //     setShowOutwardTransport(true);
  //     setShowHandlingAgent(false);
  //   } else if (value === "REM : REMOVAL") {
  //     setShowPartyImporter(true);
  //     setShowOutwardTransport(false);
  //     setShowHandlingAgent(false);
  //   } else if (
  //     value === "TTF : THRU TRANSHIPMENT WITHIN SAME FTZ" ||
  //     value === "TTI : THRU TRANSHIPMENT WITH INTER-GATEWAY MOVEMENT"
  //   ) {
  //     setShowHandlingAgent(true);
  //     setShowOutwardCarrier(true);
  //     setShowInwardCarrier(true);
  ...
  //     formData.append("InPaymentId", MSGID);
  ...
  // };
    ...
    try {
      ...
      await API.post("coo/postCooFileTable/", inFormData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
  ...
  // };
        ...
        const handleDelete = async (sno) => {
          ...
          try {
            ...
            await API.delete(`coo/deleteCooFile/${PermitId}/${sno}/`);
            console.log("Deleted from CooFile as well");
            ...
            if (commonDeleted) {
              alert(
                `Warning: File SNo ${sno} was deleted from the Common table but FAILED to delete from CooFile. ` +
  ...
  return (
    <div className="row g-2">
      ...
      <div className="col-6">
        ...
        <div className="row align-items-center compact-row mt-4">
          ...
          <fieldset>
            <div className="mt-5">
              ...
              <div className="row align-items-center mb-2">
                ...
                <div className="col-2">
                  <button className="NextpageBtns" tabIndex={16} onClick={handleAttach}>
                    ATTACH
                  </button>
                </div>
              </div>
      ...
      <div className="col-12 mt-1">
        ...
        <div className="row align-items-center compact-row" id="CoTypeShowHide">
          <div className="row mt-1">
            <div className="col-4">
              <div className="row">
                <div className="col-3">CO TYPE</div>
              </div>
              <div className="row mt-1">
              ...
              {showCommonHealth && (
                <div className="row mt-1">
                  <div className="col-12">
                    PERCENTAGE OF COMMONWEALTH PREFERENCE CONTENT
                  </div>
                </div>
              )}
              {showCommonHealth && (
                <div className="row mt-2">
                  <div className="col-11">
                    <input
                      type="text"
                      value={percentageOfCommonHealthPreference}
                      onChange={(e) =>
                        setPercentageOfCommonHealthPreference(e.target.value)
                      }
                    />
                  </div>
                </div>
              ...
              {showEntryYear && (
                <div className="row mt-1">
                  <div className="col-12">ENTRY YEAR</div>
                </div>
              )}
              {showEntryYear && (
                <div className="row mt-2">
              ...
              {showGPS && (
                <div className="row mt-1">
                  <div className="col-12">GSP DONOR COUNTRY</div>
                </div>
              )}
              {showGPS && (
                <div className="row mt-1">
                  <div className="col-11">
                    <input
                      type="text"
                      value={gspDonorCountry}
                      onChange={(e) => setGspDonorCountry(e.target.value)}
                    />
                  </div>
                </div>
              )}
