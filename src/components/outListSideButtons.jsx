...
import { useOut } from "../pages/Out/context/outContext";
...
function ListButtons({
  ...
  const { permitDetails, updatePermitDetails } = useOut();
  ...
  const handleClick = async (label) => {
    try {
      if (label === "NEW") {
        ...
        const res = await API.get(`outNew/?user=${currentUsername}`);
      ...
      if (label === "COPY") {
        ...
        const res = await API.post("copyOut/", {
